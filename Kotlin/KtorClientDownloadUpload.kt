    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        updateUIScope.launch {
            withContext(Dispatchers.IO) {
                rl.getFile("VID_20210106_110213.mp4","http://49.5.6.84:9870/webhdfs/v1/VID_20210106_110213.mp4?op=OPEN")
//                rl.uploadFile("http://49.5.6.84:9870/webhdfs/v1/alternativeMydevice2.txt?op=CREATE",Uri.EMPTY,this@MainActivity)
            }
        }
    }
}
