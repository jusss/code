...
def chat(client, model, prompt, query, history, write_content, dataset=None, retrieval_func=identity):
    ...
    while True:
        ...
        if not stream:
            ...
            if collected_messages:
                ...
                explicit_message = deepcopy(message)
                if reasoning_contents:
                    explicit_message[-1]["reasoning_content"] = "".join(["" if i is None else i for i in reasoning_contents])
            ...
            if tool_call_messages:
                ...
                explicit_message[-1]["tool_calls"] = msg["tool_calls"]
    ...
    write_content.append(explicit_message)
